...
@section('konten')
        ...
        <div
            ...
            <div class="mt-20">
                ...
                <div class="text-white my-10 text-justify text-lg pr-32">
                    {{ __('“Become one of the best construction companies with an emphasis on sustainable growth and competency building through human resource development, technology management and good corporate goverence.”') }}
                </div>
            </div>
            <div>
                <div class="text-white font-inter text-5xl font-bold uppercase">
                ...
                <div class="text-white my-10 text-justify text-lg pr-32">
                    {{ __('“Increasing the competitiveness of companies in the construction services industry by developing the best services and technology for consumers in meeting stakeholder expectations.”') }}
                </div>
            </div>
        </div>
    ...
    <section
        ...
        <div class="flex justify-center items-center self-center">
            <div class="sm:w-[500px]">
                <img src="{{ asset('img/general/about/visimisi.webp') }}" class="w-full h-full object-cover"
                    alt="agung">
            </div>
        </div>
            ...
            <div class="container mx-auto p-6">
                ...
                <div class="mt-10">
                    ...
                    <div class="text-white my-10 text-justify text-lg">
                        “Become one of the best construction companies with an emphasis on sustainable growth and competency
                        building through human resource development, technology management and good corporate goverence.”
                    </div>
                </div>
                <div>
                    <div class="text-white font-inter text-4xl text-center font-bold uppercase">
                    ...
                    <div class="text-white my-10 text-justify text-lg">
                        “Increasing the competitiveness of companies in the construction services industry by developing the
                        best services and technology for consumers in meeting stakeholder expectations.”
                    </div>
                </div>
            </div>
        </div>
    ...
    {{-- section legal --}}
    <section class="h-auto relative overfl ow-hidden" id="legal">
    ...
    <section class="h-auto bg-hitam relative overflow-hidden">
        ...
        <div class="relative left-1/2 transform -translate-y-1/2 z-[11]">
            <div class="relative mt-14">
                <div
                    class="absolute bg-clip-text text-transparent bg-[linear-gradient(180deg,_#fff_42%,_#191919_100%)] uppercase text-6xl sm:text-[7rem] top-12 sm:top-14  font-[800] transform -translate-x-1/2">
                    <h2 class="">
                        Maestro Team
                    </h2>
                </div>
            ...
            <h1
                class="text-stroke-service uppercase absolute top-28 sm:top-[10rem] text-6xl sm:text-[7rem] transform -translate-x-1/2">
                Maestro Team
            </h1>
            <h1
                class="text-stroke-service uppercase absolute top-44 sm:top-[17rem] transform -translate-x-1/2 text-6xl sm:text-[7rem]">
                Maestro Team
            </h1>
            <h1
                class="text-stroke-service uppercase absolute top-60 sm:top-[24rem] transform -translate-x-1/2 text-6xl sm:text-[7rem]">
                Maestro Team
            </h1>
        </div>
        ...
        <div class="container mx-auto px-[20%] absolute bottom-10 left-1/2 transform -translate-x-1/2 z-[11]">
            <div class="text-white font-inter text-center text-lg">
                {{ __("'If not the people of this nation who build their own country, then who else? Let's not expect others to come and build our nation, my brothers.' - B.J. Habibie, Presiden ke 3 RI") }}
            </div>
        </div>
        <!--<div class="my-5"></div>-->
    </section>
