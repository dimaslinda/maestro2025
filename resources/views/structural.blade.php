...
@section('konten')
    ...
    <section
        ...
        <div class="bg-hitam/90 h-full relative">
            ...
            <div class="container mx-auto p-6 sm:p-20 2xl:p-32 relative">
                <h2 class="text-[#ffff] font-bold uppercase text-4xl text-center sm:text-left sm:text-7xl font-inter mb-2">
                    Konstruksi
                </h2>
        ...
        <div class="flex flex-col xl:flex-row justify-between mb-5 lg:mb-10">
            ...
            <div class="w-full xl:w-1/2 relative z-[11] py-20 flex items-center">
                <div class="container mx-auto px-10 2xl:px-20 flex flex-col">
                    <div class="font-inter text-center xl:text-left text-4xl font-bold text-[#ffff] mb-5 leading-normal">
                    ...
                    <div class="w-full">
                        <a href="https://api.whatsapp.com/send?phone=6285656568527" target="_blank"
                            ...
                            <span
                                class="relative w-full text-left text-[#ffff] uppercase transition-colors duration-200 ease-in-out xl:text-tombol group-hover:text-hitam lg:group-hover:text-[#ffff]">Konsultasi
                                Sekarang</span>
                ...
                <div class="container mx-auto px-10 2xl:px-20 flex flex-col">
                    ...
                    <div class="flex justify-end">
                        <a href="https://api.whatsapp.com/send?phone=6285656568527" target="_blank"
                            ...
                            <span
                                class="relative w-full text-left text-[#ffff] xl:text-tombol transition-colors duration-200 ease-in-out group-hover:text-hitam lg:group-hover:text-[#ffff] uppercase">Konsultasi
                                Sekarang</span>
                    ...
                    <div class="w-full">
                        <a href="https://api.whatsapp.com/send?phone=6285656568527" target="_blank"
                            ...
                            <span
                                class="absolute top-0 left-0 -mt-1 w-48 h-48 bg-[#ffff] opacity-100 transition-all duration-500 ease-in-out rotate-45 -translate-x-56 -translate-y-24 lg:bg-tombol group-hover:-translate-x-8"></span>
                            <span
                                class="relative w-full text-left text-[#ffff] uppercase transition-colors duration-200 ease-in-out xl:text-tombol group-hover:text-hitam lg:group-hover:text-[#ffff]">{{
                                __('Consult Now') }}</span>
                            <span class="absolute inset-0 rounded-full border-2 border-[#ffff] xl:border-tombol"></span>
                        </a>
                    </div>
    ...
    {{-- end section korosi --}}
    {{-- section keunggulan --}}
    <section class="h-auto bg-hitam relative z-[12] overflow-hidden">
        <div class="container mx-auto p-6 z-10 relative">
            @php
                // Tampilan Keunggulan Kami (Sudah dalam Bahasa Indonesia)
            @endphp
        ...
        <div class="flex absolute -bottom-40 2xl:-bottom-80 right-0">
            <div class="relative flex">
                <svg xmlns="http://www.w3.org/2000/svg"
                    class="w-40 sm:w-52 2xl:w-80 absolute bottom-0 -right-0 md:-right-12 lg:-right-32" viewBox="0 0 245 529"
                    fill="none">
                    <path opacity="0.71"
                        d="M168.923 1.4707H185.482V142.137L100.212 264.348L100.036 264.601L100.183 264.873L243.479 528.5H185.982H143.606L0.580139 253.746L168.923 1.4707Z"
                        stroke="#c22030" />
            ...
            <div class="py-10 xl:py-20">
                ...
                <div class="flex flex-wrap gap-4 justify-center p-0 w-full md:p-5 my-20">
                    ...
                    <img src="{{ asset('img/general/logo/patria.webp') }}"
                        class="w-[30%] lg:w-[18%] 2xl:w-[20%] aspect-video object-contain" loading="lazy" alt="logo patria">
                    ...
                    <img src="{{ asset('img/general/logo/prima.webp') }}"
                        class="w-[30%] lg:w-[18%] 2xl:w-[20%] aspect-video object-contain" loading="lazy" alt="logo prima">
                    ...
                    <img src="{{ asset('img/general/logo/sinar.webp') }}"
                        class="w-[30%] lg:w-[18%] 2xl:w-[20%] aspect-video object-contain" loading="lazy" alt="logo sinar">
                    <img src="{{ asset('img/general/logo/bpjs.webp') }}"
                        class="w-[30%] lg:w-[18%] 2xl:w-[20%] aspect-video object-contain" loading="lazy" alt="logo bpjs">
                        ...
                        <div class="bg-gradient-to-t from-[#ffff]/100 to-transparent w-full h-full absolute bottom-0">
                            <div class="absolute bottom-0 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
                                <a href="#" class="relative inline-block px-5 py-3 font-medium group rounded-full">
                                    ...
                                    <span
                                        class="relative text-[#ffff] group-hover:text-[#ffff] uppercase font-league font-bold">Konsultasi
                                        Sekarang</span>
                                </a>
                            </div>
                        </div>
