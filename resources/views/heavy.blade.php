...
@section('konten')
    ...
    {{-- end section banner --}}
    {{-- section commercial --}}
    <section class="h-auto bg-hitam relative overflow-hidden" id="commercial">
            ...
            <div class="w-full 2xl:w-1/2 relative z-[11]">
                <div class="container mx-auto pt-0 pr-6 pl-6 xl:pt-56 2xl:pr-32 xl:pl-5">
                    ...
                    <div class="text-white text-justify 2xl:text-left font-inter font-light">
                        Jelajahi kemewahan bangunan komersial yang dirancang khusus untuk mendukung kesuksesan bisnis Anda!
                        Nikmati fasilitas unggulan seperti pusat perbelanjaan, perkantoran, hotel, dan pusat bisnis yang
                        menjamin kenyamanan dan produktivitas optimal.
                    </div>
        ...
        <div class="flex flex-col xl:flex-row-reverse justify-between mb-5 lg:mb-10">
            ...
            <div class="w-full 2xl:w-1/2 relative z-[11]">
                <div class="container mx-auto pt-0 pr-6 pl-6 xl:pt-56 2xl:pr-10 xl:pl-20">
                    ...
                    <div class="text-white text-justify 2xl:text-left font-inter font-light">
                        Jelajahi kenyamanan dan gaya bangunan tempat tinggal kami yang dibuat untuk individu dan keluarga!
                        Pilih dari berbagai pilihan, termasuk apartemen, flat, dan perumahan tertutup, yang dirancang untuk
                        meningkatkan pengalaman hidup Anda.
                    </div>
    ...
    <section class="h-auto bg-hitam relative overflow-hidden" id="infrastructure">
        <div class="h-full absolute bottom-0 left-0 xl:-left-[400px] 2xl:left-0">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-full" viewBox="0 0 690 431" fill="none">
                <g filter="url(#filter0_d_577_724)">
                    <path d="M-2 0H629L686 272.5L629 431H-2V0Z" fill="#EFBF04" />
        ...
        <div class="flex flex-col xl:flex-row justify-between mb-5 lg:mb-10">
                        ...
                        <div class="slide">
                            <div class="h-60 w-96">
                                <img src="{{ asset('img/general/heavy/infrastructure-1.webp') }}" loading="lazy"
                                    class="w-full h-full object-contain" alt="infrastruktur">
                            </div>
                        </div>
                        <div class="slide">
                            <div class="h-60 w-96">
            ...
            <div class="w-full 2xl:w-1/2 relative z-[11]">
                <div class="container mx-auto pt-0 pr-6 pl-6 xl:pt-56 2xl:pr-32 xl:pl-5">
                    ...
                    <div class="text-white text-justify 2xl:text-left font-inter font-light">
                        Temukan tulang punggung kehidupan modern dengan solusi infrastruktur publik kami yang komprehensif!
                        Mulai dari jalan dan jembatan yang terawat baik hingga transportasi umum yang efisien, listrik yang
                        andal, air bersih, dan telekomunikasi canggih, kami memenuhi kebutuhan sehari-hari Anda.
                    </div>
                    <a href="https://api.whatsapp.com/send?phone=6285656568527" target="_blank"
                        class="relative mt-5 items-center justify-start inline-block px-3 sm:px-5 py-2 overflow-hidden font-bold rounded-full group">
                        <span
        ...
        <div class="flex flex-col xl:flex-row-reverse justify-between mb-5 lg:mb-10">
                        ...
                        <div class="slide">
                            <div class="h-60 w-96">
                                <img src="{{ asset('img/general/heavy/building-1.webp') }}" loading="lazy"
                                    class="w-full h-full object-contain" alt="bangunan">
                            </div>
                        </div>
                        <div class="slide">
                            <div class="h-60 w-96">
            ...
            <div class="w-full 2xl:w-1/2 relative z-[11]">
                <div class="container mx-auto pt-0 pr-6 pl-6 xl:pt-56 2xl:pr-10 xl:pl-20">
                    ...
                    <div class="text-white text-justify 2xl:text-left font-inter font-light">
                        Rasakan lambang inovasi dalam desain arsitektur! Bangunan kami tidak hanya mencerminkan kemajuan dan
                        identitas perusahaan Anda tetapi juga menawarkan ruang kantor fungsional yang dilengkapi dengan
                        teknologi mutakhir, memastikan lingkungan kerja yang efisien dan nyaman. Tingkatkan ruang kerja Anda
                        ke level baru.
                    </div>
                    <div class="flex justify-end">
                        <a href="https://api.whatsapp.com/send?phone=6285656568527" target="_blank"
