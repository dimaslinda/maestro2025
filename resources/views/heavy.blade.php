            ...
            <div class="relative container mx-auto py-20 xl:py-60 pl-6 pr-6 xl:pl-20 w-full xl:w-[65%]">
                <div class="slider">
                    <div class="slide-track space-x-2 lg:space-x-5">
                        <div class="slide">
                            <div class="h-60 w-96">
                                <img src="{{ asset('img/general/heavy/commercial-1.webp') }}" loading="lazy"
                                    class="w-full h-full object-contain" alt="">
                            </div>
                        </div>
                        <div class="slide">
                            <div class="h-60 w-96">
                                <img src="{{ asset('img/general/heavy/commercial-2.webp') }}" loading="lazy"
                                    class="w-full h-full object-contain" alt="">
                            </div>
                        </div>
                        <div class="slide">
                            <div class="h-60 w-96">
                                <img src="{{ asset('img/general/heavy/commercial-3.webp') }}" loading="lazy"
                                    class="w-full h-full object-contain" alt="">
                            </div>
                        </div>
                        <div class="slide">
            ...
            <div class="w-full 2xl:w-1/2 relative z-[11]">
                <div class="container mx-auto pt-0 pr-6 pl-6 xl:pt-56 2xl:pr-32 xl:pl-5">
                    <div class="font-inter text-center 2xl:text-left text-4xl font-bold text-white mb-5">
                        {{ __('Commercial Building') }}
                    </div>
                    <div class="text-white text-justify 2xl:text-left font-inter font-light">
                        {{ __('Explore the luxury of a commercial building specifically designed to support your business success! Enjoy excellent facilities such as shopping malls, offices, hotels, and business centers that ensure optimal comfort and productivity.') }}
                    </div>
                    <a href="https://api.whatsapp.com/send?phone=6285656568527" target="_blank"
                        ...
                        <span
                            class="relative w-full text-left text-white lg:text-tombol transition-colors duration-200 ease-in-out group-hover:text-hitam lg:group-hover:text-white uppercase">{{ __('Consult Now') }}</span>
        ...
        <div class="flex flex-col xl:flex-row-reverse justify-between mb-5 lg:mb-10">
            <div class="relative container mx-auto py-20 xl:py-60 pl-6 pr-20 xl:pl-0 w-full xl:w-[65%]">
                <div class="slider2">
                    <div class="slide-track space-x-2 lg:space-x-5">
                        <div class="slide">
                            <div class="h-60 w-96">
                                <img src="{{ asset('img/general/heavy/house-1.webp') }}" loading="lazy"
                                    class="w-full h-full object-contain" alt="house">
                            </div>
                        </div>
                        <div class="slide">
                            <div class="h-60 w-96">
                                <img src="{{ asset('img/general/heavy/house-2.webp') }}" loading="lazy"
                                    class="w-full h-full object-contain" alt="house">
                            </div>
                        </div>
                        <div class="slide">
                            <div class="h-60 w-96">
                                <img src="{{ asset('img/general/heavy/house-3.webp') }}" loading="lazy"
                                    class="w-full h-full object-contain" alt="house">
                            </div>
                        </div>
                        <div class="slide">
            ...
            <div class="w-full 2xl:w-1/2 relative z-[11]">
                <div class="container mx-auto pt-0 pr-6 pl-6 xl:pt-56 2xl:pr-10 xl:pl-20">
                    ...
                    <div class="text-white text-justify 2xl:text-left font-inter font-light">
                        {{ __('Explore the comfort and style of our residential buildings crafted for individuals and families! Choose from a range of options, including apartments, flats, and closed housing, designed to enhance your living experience.') }}
                    </div>
        ...
        <div class="flex flex-col xl:flex-row justify-between mb-5 lg:mb-10">
            <div class="relative container mx-auto py-20 xl:py-60 pl-6 pr-6 xl:pl-20 w-full xl:w-[65%]">
                <div class="slider">
                    <div class="slide-track space-x-2 lg:space-x-5">
                        <div class="slide">
                            <div class="h-60 w-96">
                                <img src="{{ asset('img/general/heavy/infrastructure-1.webp') }}" loading="lazy"
                                    class="w-full h-full object-contain" alt="infrastructure">
                            </div>
                        </div>
                        <div class="slide">
                            <div class="h-60 w-96">
                                <img src="{{ asset('img/general/heavy/infrastructure-2.webp') }}" loading="lazy"
                                    class="w-full h-full object-contain" alt="infrastructure">
                            </div>
                        </div>
                        <div class="slide">
                            <div class="h-60 w-96">
                                <img src="{{ asset('img/general/heavy/infrastructure-3.webp') }}" loading="lazy"
                                    class="w-full h-full object-contain" alt="infrastructure">
                            </div>
                        </div>
                        <div class="slide">
            ...
            <div class="w-full 2xl:w-1/2 relative z-[11]">
                <div class="container mx-auto pt-0 pr-6 pl-6 xl:pt-56 2xl:pr-32 xl:pl-5">
                    ...
                    <div class="text-white text-justify 2xl:text-left font-inter font-light">
                        {{ __("Discover the backbone of modern living with our comprehensive public infrastructure solutions! From well-maintained roads and bridges to efficient public transportation, reliable electricity, clean water, and advanced telecommunications, we've got your everyday needs covered.") }}
                    </div>
                    <a href="https://api.whatsapp.com/send?phone=6285656568527" target="_blank"
                        class="relative mt-5 items-center justify-start inline-block px-3 sm:px-5 py-2 overflow-hidden font-bold rounded-full group">
                        <span
            ...
            <div class="relative container mx-auto py-20 xl:py-60 pl-6 pr-20 xl:pl-0 w-full xl:w-[65%]">
                <div class="slider2">
                    <div class="slide-track space-x-2 lg:space-x-5">
                        <div class="slide">
                            <div class="h-60 w-96">
                                <img src="{{ asset('img/general/heavy/building-1.webp') }}" loading="lazy"
                                    class="w-full h-full object-contain" alt="building">
                            </div>
                        </div>
                        <div class="slide">
                            <div class="h-60 w-96">
                                <img src="{{ asset('img/general/heavy/building-2.webp') }}" loading="lazy"
                                    class="w-full h-full object-contain" alt="building">
                            </div>
                        </div>
                        <div class="slide">
                            <div class="h-60 w-96">
                                <img src="{{ asset('img/general/heavy/building-3.webp') }}" loading="lazy"
                                    class="w-full h-full object-contain" alt="building">
                            </div>
                        </div>
                        <div class="slide">
                            <div class="h-60 w-96">
                                <img src="{{ asset('img/general/heavy/building-4.png') }}" loading="lazy"
                                    class="w-full h-full object-contain" alt="building">
                            </div>
                        </div>
            ...
            <div class="container mx-auto p-0 lg:p-20">
                <div class="flex flex-col sm:flex-row space-x-0 lg:space-x-10 justify-center">
                    <div class="w-96 h-96 p-6 lg:px-10">
                        ...
                        <div class="font-inter text-white">
                            <h5 class="text-center my-5 text-xl sm:text-lg lg:text-xl px-5 capitalize font-bold">
                                {{ __('Discount With Certain Conditions') }}
                            </h5>
                            <p class="text-center text-lg px-5 sm:px-2 lg:px-5">
                                {{ __("Enjoy special discounts with certain conditions now! Don't miss this opportunity") }}
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="w-96 h-96 p-6 lg:px-10">
                        ...
                        <div class="font-inter text-white">
                            <h5 class="text-center my-5 text-xl sm:text-lg lg:text-xl px-5 capitalize font-bold">
                                {{ __('Bonus (Electronic Accessories, Kitchen Set)') }}
                            </h5>
                            <p class="text-center text-lg px-5 sm:px-2 lg:px-5">
                                {{ __('Get exclusive bonuses! Choose your favorite products') }}
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="w-96 h-96 p-6 lg:px-10">
                        ...
                        <div class="font-inter text-white">
                            <h5 class="text-center my-5 text-xl sm:text-lg lg:text-xl px-5 capitalize font-bold">
                                {{ __('Bundling - Limited Offering') }}
                            </h5>
                            <p class="text-center text-lg px-5 sm:px-2 lg:px-5">
                                {{ __("Don't miss out on special offers! Get an exclusive savings package") }}
                            </p>
                        </div>
                    </div>
                        ...
                        <div class="bg-gradient-to-t from-white/100 to-transparent w-full h-full absolute bottom-0">
                            <div class="absolute bottom-0 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
                                <a href="#" class="relative inline-block px-5 py-3 font-medium group rounded-full">
                                    ...
                                    <span
                                        class="relative text-white group-hover:text-white uppercase font-league font-bold">{{ __('Consult Now') }}</span>
                                </a>
                            </div>
                        </div>
                    </div>
